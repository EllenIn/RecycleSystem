#pragma checksum "E:\Senkuu\RecycleSystem\RecycleSystem.MVC\Views\OrderManage\ViewReleasedOrders.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "50e0b65069dd146c05056351f6edb7656d78e464"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"50e0b65069dd146c05056351f6edb7656d78e464", @"/Views/OrderManage/ViewReleasedOrders.cshtml")]
...
<script type");
    ...
    {{#  if(d.status == 1){ }}
    <span style=""color: #F581B1;width:200px"">未接单</span>
    {{#  } else if (d.status == 2){ }}
    <span style=""color:orangered; width:200px;"">进行中</span>
    {{#  } else if (d.status == 3){ }}
    <span style=""color:greenyellow;width:200px"">已完成</span>
    {{#  } }}
