#pragma checksum "D:\Users\Senku\source\repos\SenkuuChin\RecycleSystem\RecycleSystem.MVC\Views\OrderManage\ViewReleasedOrders.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "774617de62e7d90de02bb524cbec227d04811bfc"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_OrderManage_ViewReleasedOrders), @"mvc.1.0.view", @"/Views/OrderManage/ViewReleasedOrders.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"774617de62e7d90de02bb524cbec227d04811bfc", @"/Views/OrderManage/ViewReleasedOrders.cshtml")]
    ...
    public class Views_OrderManage_ViewReleasedOrders : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            WriteLiteral("\r\n");
#nullable restore
#line 2 "D:\Users\Senku\source\repos\SenkuuChin\RecycleSystem\RecycleSystem.MVC\Views\OrderManage\ViewReleasedOrders.cshtml"
...
<script type=""text/html"" id=""toolbarDemo"">
    <div class=""layui-btn-container"">
        <button class=""layui-btn layui-btn-sm"" onclick=""btn_add()""><i class=""layui-icon""></i>发布需求订单</button>
    </div>
</script>
...
<script type=""text/html"" id=""operation"">
    <div class=""layui-row"">
        ...
        <button class=""layui-btn layui-btn-sm layui-btn-danger"" lay-event=""withdrew""><i class=""layui-icon""></i>撤销订单</button>
    </div>
</script>
...
<script type");
            WriteLiteral(@"=""text/html"" id=""statusId"">
    {{#  if(d.status == 1){ }}
...
<script>
    ...
    layui.use('table', function () {
        ...
        table.render({
            elem: '#orderList'
            , url: '/OrderManage/GetMyOrders'
            , toolbar: '#toolbarDemo' //开启头部工具栏，并为其绑定左侧模板
            , defaultToolbar: ['filter', 'exports', 'print', { //自定义头部工具栏右侧图标。如无需自定义，去除");
            WriteLiteral(@"该参数即可
                title: '提示'
            ...
            , cols: [[
                ...
                ,");
            WriteLiteral(@" { field: 'status', title: '状态', width: 130, sort: false, templet: '#statusId' }
        ...
        table.on('tool(orderList)', function (obj) {
            ...
            switch (obj.event) {
                ...
                case 'withdrew':
                    layer.confirm('确认撤销订单 ' + data.oid + ' 吗?', funct");
            WriteLiteral(@"ion (index) {
                        $.ajax({
                            url: ""/OrderManage/WithdrewMyApplication"",
                            type: ""post"",
                            data: { oid: data.oid },
    ...
    btn_add = function () {
        ...
        layui.use('layer', function () {
            layer.open({
                ...
                area: ['893px', '600px'],
                content: '/OrderManage/ReleaseOrder'
            });
        })
    };
</script>
